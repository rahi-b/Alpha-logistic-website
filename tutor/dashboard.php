...
$footer_links = array(
	array(
		'title'      => $is_instructor ? __( 'My Courses', 'transto' ) : __( 'Dashboard', 'transto' ),
		'url'        => $footer_url_1,
		'is_active'  => $footer_url_1 == $current_url,
		'icon_class' => 'ttr tutor-icon-dashboard-filled',
	),
	array(
		'title'      => $is_instructor ? __( 'Q&A', 'transto' ) : __( 'Quiz Attempts', 'transto' ),
		'url'        => $footer_url_2,
				...
				<div class="tutor-d-flex tutor-align-items-center">
					...
					?>
						<a id="tutor-become-instructor-button" style="vertical-align:middle" class="tutor-btn tutor-btn-tertiary tutor-is-outline" href="<?php echo esc_url(tutor_utils()->instructor_register_url()); ?>">
							<i class="tutor-icon-man-user-filled tutor-icon-24"></i> &nbsp; <?php _e('Become an instructor', 'transto'); ?>
						</a>
					<?php
					}
					...
					?>
						<a class="tutor-btn tutor-btn-tertiary tutor-is-outline" href="<?php echo esc_url(apply_filters('frontend_course_create_url', admin_url('post-new.php?post_type=' . tutor()->course_post_type))); ?>">
							<i class="tutor-icon-plus-square-filled tutor-icon-24 tutor-mr-12"></i> <?php esc_html_e('Create a New Course', 'transto'); ?>
						</a>
					<?php
						...
						__('Your Application is pending as of', 'transto'), ' <b>', $on, '</b>',
						'</span>';
