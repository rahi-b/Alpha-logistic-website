...
<div class="row">
	...
	<div class="col tx_coll d-flex align-items-center justify-content-between flex-wrap <?php echo $transto_opt['topflex_select'];?>">
		...
		<?php endif; ?>		
		<!-- Middle -->
		<?php if($transto_opt['top_welcome_hide'] || $transto_opt['top_opening_hide']):?>		
		...
		<?php endif; ?>	
		<!-- TOP RIGHT -->
		<?php if($transto_opt['top_menu_hide'] || $transto_opt['top_icon_hide'] || $transto_opt['top_login_hide'] || $transto_opt['top_search_hide']):?>		
		<div class="top-right-menu d-flex flex-wrap">
